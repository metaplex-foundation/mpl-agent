...
impl ReviewsConfigV1 {
    ...
    ///
    ///   0. `ReviewsConfigV1::PREFIX`
    pub const PREFIX: &'static [u8] = "program_config".as_bytes();

    pub fn create_pda(
        bump: u8,
    ) -> Result<solana_program::pubkey::Pubkey, solana_program::pubkey::PubkeyError> {
        solana_program::pubkey::Pubkey::create_program_address(
            &["program_config".as_bytes(), &[bump]],
...
impl<'a> TryFrom<&solana_program::account_info::AccountInfo<'a>> for ReviewsConfigV1 {
