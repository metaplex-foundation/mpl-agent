...
impl DelegateExecutionV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&(DelegateExecutionV1InstructionData::new())).unwrap();
...
pub struct DelegateExecutionV1InstructionData {
    discriminator: u8,
    padding: [u8; 7],
}

impl DelegateExecutionV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 1,
...
/// Instruction builder for `DelegateExecutionV1`.
///
/// ### Accounts:
///
///   0. `[]` executive_profile
...
impl DelegateExecutionV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The executive profile
...
/// `delegate_execution_v1` CPI instruction.
...
impl<'a, 'b> DelegateExecutionV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: DelegateExecutionV1CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DelegateExecutionV1` via CPI.
///
/// ### Accounts:
///
///   0. `[]` executive_profile
...
///   5. `[signer, optional]` authority
///   6. `[]` system_program
pub struct DelegateExecutionV1CpiBuilder<'a, 'b> {
    instruction: Box<DelegateExecutionV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DelegateExecutionV1CpiBuilder<'a, 'b> {
