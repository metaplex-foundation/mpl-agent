...
impl RegisterValidationV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&(RegisterValidationV1InstructionData::new())).unwrap();

        solana_program::instruction::Instruction {
            program_id: crate::MPL_AGENT_VALIDATION_ID,
            accounts,
            data,
        }
    }
...
pub struct RegisterValidationV1InstructionData {
    discriminator: u8,
    padding: [u8; 7],
}

impl RegisterValidationV1InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: 0,
...
/// Instruction builder for `RegisterValidationV1`.
///
/// ### Accounts:
///
...
impl RegisterValidationV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The agent validation PDA
    #[inline(always)]
    pub fn agent_validation(
        &mut self,
        agent_validation: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
...
/// `register_validation_v1` CPI accounts.
...
/// `register_validation_v1` CPI instruction.
pub struct RegisterValidationV1Cpi<'a, 'b> {
...
impl<'a, 'b> RegisterValidationV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RegisterValidationV1CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RegisterValidationV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` agent_validation
...
impl<'a, 'b> RegisterValidationV1CpiBuilder<'a, 'b> {
    ...
    pub fn agent_validation(
        &mut self,
        agent_validation: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(
        ...
        let instruction = RegisterValidationV1Cpi {
            __program: self.instruction.__program,

            agent_validation: self
                .instruction
                .agent_validation
