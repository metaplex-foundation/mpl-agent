...
use crate::processor::{
    CreateReviewsCollectionV1Args, LeaveReviewV1Args, RegisterReputationV1Args,
...
impl TryFrom<u8> for MplAgentReputationInstructionDiscriminant {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            ...
            2 => Ok(MplAgentReputationInstructionDiscriminant::CreateReviewsCollectionV1),
