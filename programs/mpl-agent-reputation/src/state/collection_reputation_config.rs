...
pub struct CollectionReputationConfigV1 {
...
const _: () = assert!(core::mem::size_of::<CollectionReputationConfigV1>() % 8 == 0);
const _: () = assert!(core::mem::size_of::<CollectionReputationConfigV1>() == 40);

impl CollectionReputationConfigV1 {
    /// PDA seed prefix for this account type.
    pub const PREFIX: &'static [u8] = b"collection_reputation_config";
    ...
    pub fn create_account(accounts: &RegisterReputationV1Accounts, bump: u8) -> ProgramResult {
        solana_program::msg!("Creating collection reputation config account");
        create_or_allocate_account_raw(
            crate::ID,
            accounts.collection_reputation_config,
            accounts.system_program,
            accounts.payer,
            core::mem::size_of::<CollectionReputationConfigV1>(),
    ...
    pub fn initialize(&mut self, bump: u8, collection: &Pubkey) {
        solana_program::msg!("Initializing collection reputation config account");
        self.key = Key::CollectionReputationConfigV1 as u8;
        self.bump = bump;
        self._padding = [0u8; 6];
